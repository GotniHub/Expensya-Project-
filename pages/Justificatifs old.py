...
ONEDRIVE_URL = "https://adventplus-my.sharepoint.com/:u:/g/personal/igotni_adv-sud_fr/EWiRHUyGQAxGsXNZIaZC5qUBzATLTp6-imcs-p0obZGJyQ?download=1"
# -------------------------
# Traitement
# -------------------------
    ...
    try:
        ...
        for mission, group in grouped:
            ...
            for _, row in group.iterrows():
                ...
                # --- Nouveau : extraire mois/année depuis la colonne Date
                ...
                # --- Dossier mission / mois / consultant
                mois_dir = os.path.join(justif_path, mois_str)
                user_dir = os.path.join(mois_dir, user_name)
                os.makedirs(user_dir, exist_ok=True)

                # --- Copier justificatifs correspondants
